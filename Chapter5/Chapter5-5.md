...
In outline, we start from deciding a initial BFS, then make the tableau from the BFS. While the tableau shows the optimal solution, we repeat pivoting and renew the tableau.  
